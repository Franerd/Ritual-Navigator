...
2. Place `RitualNavigator_0.5.0.ghmod` in the GHMod mods directory.
...
Version 0.5.0 was developed and tested in Green Hell Story mode with GHMod. Multiplayer and non-Story modes are intentionally outside the supported scope.
